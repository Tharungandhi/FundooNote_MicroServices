...
public class UserController {
 ...
 public ResponseEntity<?> uploadPhoto(@RequestBody UserDetails user, @PathVariable("token")String token,
		 HttpServletRequest request){
	 UserDetails photo=userService.uploadPic(user,token,request);
	 if(photo!=null) {
			return  new ResponseEntity<Void>( HttpStatus.OK);
